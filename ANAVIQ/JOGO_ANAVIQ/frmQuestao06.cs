...
namespace TwoQ
{
    public partial class frmQuestao06 : Form
    {
        ...
        Image img_btn_correto06_normal; // botão normal
        Image img_btn_correto06_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto06_normal; // botão normal
        Image img_btn_quasecorreto06_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado06_normal; // botão normal
        Image img_btn_errado06_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo06_normal; // botão normal
        Image img_btn_absurdo06_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao06()
        {
            ...
            img_btn_correto06_normal = Properties.Resources.btn_correto06_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto06_normal
            img_btn_correto06_high = Properties.Resources.btn_correto06_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto06_high

            img_btn_quasecorreto06_normal = Properties.Resources.btn_quasecorreto06_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto06_normal
            img_btn_quasecorreto06_high = Properties.Resources.btn_quasecorreto06_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto06_high

            img_btn_errado06_normal = Properties.Resources.btn_errado06_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado06_normal
            img_btn_errado06_high = Properties.Resources.btn_errado06_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado06_high

            img_btn_absurdo06_normal = Properties.Resources.btn_absurdo06_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo06_normal
            img_btn_absurdo06_high = Properties.Resources.btn_absurdo06_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo06_high
        }


        int alternativas;
        private void frmQuestao06_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto06_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto06_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado06_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo06_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao06_RespotaCorreta RespostaCorreta = new frmQuestao06_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto06_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao06_RespostaErrada RespostaErrada = new frmQuestao06_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto06_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado06_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo06_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
