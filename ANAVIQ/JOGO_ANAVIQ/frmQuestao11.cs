...
namespace TwoQ
{
    public partial class frmQuestao11 : Form
    {
        ...
        Image img_btn_correto11_normal; // botão normal
        Image img_btn_correto11_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto11_normal; // botão normal
        Image img_btn_quasecorreto11_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado11_normal; // botão normal
        Image img_btn_errado11_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo11_normal; // botão normal
        Image img_btn_absurdo11_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao11()
        {
            ...
            img_btn_correto11_normal = Properties.Resources.btn_correto11_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto11_normal
            img_btn_correto11_high = Properties.Resources.btn_correto11_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto11_high

            img_btn_quasecorreto11_normal = Properties.Resources.btn_quasecorreto11_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto11_normal
            img_btn_quasecorreto11_high = Properties.Resources.btn_quasecorreto11_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto11_high

            img_btn_errado11_normal = Properties.Resources.btn_errado11_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado11_normal
            img_btn_errado11_high = Properties.Resources.btn_errado11_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado11_high

            img_btn_absurdo11_normal = Properties.Resources.btn_absurdo11_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo11_normal
            img_btn_absurdo11_high = Properties.Resources.btn_absurdo11_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo11_high
        }


        int alternativas;
        private void frmQuestao11_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto11_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto11_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado11_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo11_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao11_RespotaCorreta RespostaCorreta = new frmQuestao11_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto11_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao11_RespostaErrada RespostaErrada = new frmQuestao11_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto11_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado11_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo11_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
