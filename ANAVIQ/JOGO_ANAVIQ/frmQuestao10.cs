...
namespace TwoQ
{
    public partial class frmQuestao10 : Form
    {
        ...
        Image img_btn_correto10_normal; // botão normal
        Image img_btn_correto10_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto10_normal; // botão normal
        Image img_btn_quasecorreto10_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado10_normal; // botão normal
        Image img_btn_errado10_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo10_normal; // botão normal
        Image img_btn_absurdo10_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao10()
        {
            ...
            img_btn_correto10_normal = Properties.Resources.btn_correto10_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto10_normal
            img_btn_correto10_high = Properties.Resources.btn_correto10_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto10_high

            img_btn_quasecorreto10_normal = Properties.Resources.btn_quasecorreto10_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto10_normal
            img_btn_quasecorreto10_high = Properties.Resources.btn_quasecorreto10_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto10_high

            img_btn_errado10_normal = Properties.Resources.btn_errado10_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado10_normal
            img_btn_errado10_high = Properties.Resources.btn_errado10_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado10_high

            img_btn_absurdo10_normal = Properties.Resources.btn_absurdo10_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo10_normal
            img_btn_absurdo10_high = Properties.Resources.btn_absurdo10_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo10_high
        }


        int alternativas;
        private void frmQuestao10_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto10_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto10_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado10_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo10_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao10_RespotaCorreta RespostaCorreta = new frmQuestao10_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto10_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao10_RespostaErrada RespostaErrada = new frmQuestao10_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto10_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado10_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo10_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
