...
namespace TwoQ
{
    public partial class frmQuestao11_RespotaCorreta : Form
    {
        ...
        private void frmQuestao11_RespotaCorreta_Load(object sender, EventArgs e)
        {
