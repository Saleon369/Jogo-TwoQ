...
namespace TwoQ
{    public partial class frmQuestao02_RespostaErrada : Form
    {

        // === Imagem Pergunta Errada 02
        Image img_resposta_errada_02;
        Image img_resposta_errada_certa_02;
        ...
        public frmQuestao02_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_02 = Properties.Resources.Resposta_Errada_02;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_02
            img_resposta_errada_certa_02 = Properties.Resources.Resposta_Errada_Certa_02; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_02
        ...
        private void frmQuestao02_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_02;  // atribuição da imagem na picturebox (resposta_errada_02)
        }
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_02; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_02; // Altera para a imagem com a dica
