...
namespace TwoQ
{    public partial class frmQuestao05_RespostaErrada : Form
    {

        // === Imagem Pergunta Errada 05
        Image img_resposta_errada_05;
        Image img_resposta_errada_certa_05;
        ...
        public frmQuestao05_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_05 = Properties.Resources.Resposta_Errada_05;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_05
            img_resposta_errada_certa_05 = Properties.Resources.Resposta_Errada_Certa_05; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_05
        ...
        private void frmQuestao05_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_05;  // atribuição da imagem na picturebox (resposta_errada_05)
        }
        ...
        {
            frmQuestao06 Questao06 = new frmQuestao06();
            this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_05; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_05; // Altera para a imagem com a dica
