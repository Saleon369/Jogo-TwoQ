...
namespace TwoQ
{    public partial class frmQuestao12_RespostaErrada : Form
    {
        // === Imagem Pergunta Errada 12
        Image img_resposta_errada_12;
        Image img_resposta_errada_certa_12;
        ...
        public frmQuestao12_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_12 = Properties.Resources.Resposta_Errada_12;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_12
            img_resposta_errada_certa_12 = Properties.Resources.Resposta_Errada_Certa_12; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_12
        ...
        private void frmQuestao12_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_12;  // atribuição da imagem na picturebox (resposta_errada_12)
        }
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_12; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_12; // Altera para a imagem com a dica
