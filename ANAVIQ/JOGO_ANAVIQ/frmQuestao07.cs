...
namespace TwoQ
{
    public partial class frmQuestao07 : Form
    {
        ...
        Image img_btn_correto07_normal; // botão normal
        Image img_btn_correto07_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto07_normal; // botão normal
        Image img_btn_quasecorreto07_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado07_normal; // botão normal
        Image img_btn_errado07_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo07_normal; // botão normal
        Image img_btn_absurdo07_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao07()
        {
            ...
            img_btn_correto07_normal = Properties.Resources.btn_correto07_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto07_normal
            img_btn_correto07_high = Properties.Resources.btn_correto07_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto07_high

            img_btn_quasecorreto07_normal = Properties.Resources.btn_quasecorreto07_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto07_normal
            img_btn_quasecorreto07_high = Properties.Resources.btn_quasecorreto07_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto07_high

            img_btn_errado07_normal = Properties.Resources.btn_errado07_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado07_normal
            img_btn_errado07_high = Properties.Resources.btn_errado07_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado07_high

            img_btn_absurdo07_normal = Properties.Resources.btn_absurdo07_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo07_normal
            img_btn_absurdo07_high = Properties.Resources.btn_absurdo07_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo07_high
        }


        int alternativas;
        private void frmQuestao07_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto07_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto07_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado07_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo07_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao07_RespotaCorreta RespostaCorreta = new frmQuestao07_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto07_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao07_RespostaErrada RespostaErrada = new frmQuestao07_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto07_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado07_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo07_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
