...
namespace TwoQ
{
    public partial class frmQuestao05 : Form
    {
        ...
        Image img_btn_correto05_normal; // botão normal
        Image img_btn_correto05_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto05_normal; // botão normal
        Image img_btn_quasecorreto05_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado05_normal; // botão normal
        Image img_btn_errado05_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo05_normal; // botão normal
        Image img_btn_absurdo05_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao05()
        {
            ...
            img_btn_correto05_normal = Properties.Resources.btn_correto05_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto05_normal
            img_btn_correto05_high = Properties.Resources.btn_correto05_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto05_high

            img_btn_quasecorreto05_normal = Properties.Resources.btn_quasecorreto05_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto05_normal
            img_btn_quasecorreto05_high = Properties.Resources.btn_quasecorreto05_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto05_high

            img_btn_errado05_normal = Properties.Resources.btn_errado05_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado05_normal
            img_btn_errado05_high = Properties.Resources.btn_errado05_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado05_high

            img_btn_absurdo05_normal = Properties.Resources.btn_absurdo05_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo05_normal
            img_btn_absurdo05_high = Properties.Resources.btn_absurdo05_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo05_high
        }


        int alternativas;
        private void frmQuestao05_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto05_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto05_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado05_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo05_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao05_RespotaCorreta RespostaCorreta = new frmQuestao05_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto05_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao05_RespostaErrada RespostaErrada = new frmQuestao05_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto05_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado05_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo05_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
