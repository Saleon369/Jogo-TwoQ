...
namespace TwoQ
{
    public partial class frmQuestao03 : Form
    {
        ...
        Image img_btn_correto03_normal; // botão normal
        Image img_btn_correto03_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto03_normal; // botão normal
        Image img_btn_quasecorreto03_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado03_normal; // botão normal
        Image img_btn_errado03_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo03_normal; // botão normal
        Image img_btn_absurdo03_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao03()
        {
            ...
            img_btn_correto03_normal = Properties.Resources.btn_correto03_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto03_normal
            img_btn_correto03_high = Properties.Resources.btn_correto03_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto03_high

            img_btn_quasecorreto03_normal = Properties.Resources.btn_quasecorreto03_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto03_normal
            img_btn_quasecorreto03_high = Properties.Resources.btn_quasecorreto03_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto03_high

            img_btn_errado03_normal = Properties.Resources.btn_errado03_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado03_normal
            img_btn_errado03_high = Properties.Resources.btn_errado03_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado03_high

            img_btn_absurdo03_normal = Properties.Resources.btn_absurdo03_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo03_normal
            img_btn_absurdo03_high = Properties.Resources.btn_absurdo03_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo03_high
        }


        int alternativas;
        private void frmQuestao03_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto03_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto03_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado03_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo03_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao03_RespotaCorreta RespostaCorreta = new frmQuestao03_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto03_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao03_RespostaErrada RespostaErrada = new frmQuestao03_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto03_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado03_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo03_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
