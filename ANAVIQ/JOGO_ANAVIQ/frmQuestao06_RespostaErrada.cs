...
namespace TwoQ
{    public partial class frmQuestao06_RespostaErrada : Form
    {

        // === Imagem Pergunta Errada 06
        Image img_resposta_errada_06;
        Image img_resposta_errada_certa_06;
        ...
        public frmQuestao06_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_06 = Properties.Resources.Resposta_Errada_06;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_06
            img_resposta_errada_certa_06 = Properties.Resources.Resposta_Errada_Certa_06; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_06
        ...
        private void frmQuestao06_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_06;  // atribuição da imagem na picturebox (resposta_errada_06)
        }
        ...
        private void btn_proximo_Click(object sender, EventArgs e)
        {
            ...
            {
                frmQuestao07 Questao07 = new frmQuestao07();
                this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_06; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_06; // Altera para a imagem com a dica
