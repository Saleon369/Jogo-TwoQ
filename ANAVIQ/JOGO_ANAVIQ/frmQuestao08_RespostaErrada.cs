...
namespace TwoQ
{    public partial class frmQuestao08_RespostaErrada : Form
    {
        // === Imagem Pergunta Errada 08
        Image img_resposta_errada_08;
        Image img_resposta_errada_certa_08;
        ...
        public frmQuestao08_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_08 = Properties.Resources.Resposta_Errada_08;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_08
            img_resposta_errada_certa_08 = Properties.Resources.Resposta_Errada_Certa_08; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_08
        ...
        private void frmQuestao08_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_08;  // atribuição da imagem na picturebox (resposta_errada_08)
        }
        ...
        private void btn_proximo_Click(object sender, EventArgs e)
        {
            ...
            {
                frmQuestao09 Questao09 = new frmQuestao09();
                this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_08; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_08; // Altera para a imagem com a dica
