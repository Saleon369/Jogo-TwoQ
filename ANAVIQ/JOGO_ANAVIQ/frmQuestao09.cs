...
namespace TwoQ
{
    public partial class frmQuestao09 : Form
    {
        // ==== VIDAS
        Image img_vidasFull;
        ...
        Image img_btn_correto09_normal; // botão normal
        Image img_btn_correto09_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto09_normal; // botão normal
        Image img_btn_quasecorreto09_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado09_normal; // botão normal
        Image img_btn_errado09_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo09_normal; // botão normal
        Image img_btn_absurdo09_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao09()
        {
            ...
            img_btn_correto09_normal = Properties.Resources.btn_correto09_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto09_normal
            img_btn_correto09_high = Properties.Resources.btn_correto09_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto09_high

            img_btn_quasecorreto09_normal = Properties.Resources.btn_quasecorreto09_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto09_normal
            img_btn_quasecorreto09_high = Properties.Resources.btn_quasecorreto09_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto09_high

            img_btn_errado09_normal = Properties.Resources.btn_errado09_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado09_normal
            img_btn_errado09_high = Properties.Resources.btn_errado09_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado09_high

            img_btn_absurdo09_normal = Properties.Resources.btn_absurdo09_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo09_normal
            img_btn_absurdo09_high = Properties.Resources.btn_absurdo09_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo09_high
        }


        int alternativas;
        private void frmQuestao09_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto09_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto09_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado09_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo09_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao09_RespotaCorreta RespostaCorreta = new frmQuestao09_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto09_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao09_RespostaErrada RespostaErrada = new frmQuestao09_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto09_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado09_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo09_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
