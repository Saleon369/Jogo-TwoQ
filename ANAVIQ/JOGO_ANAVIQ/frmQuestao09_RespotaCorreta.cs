...
namespace TwoQ
{
    public partial class frmQuestao09_RespotaCorreta : Form
    {
        ...
        private void frmQuestao09_RespotaCorreta_Load(object sender, EventArgs e)
        {
