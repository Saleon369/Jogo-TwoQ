...
namespace TwoQ
{
    public partial class frmQuestao08_RespotaCorreta : Form
    {
        ...
        private void frmQuestao08_RespotaCorreta_Load(object sender, EventArgs e)
        {
