...
namespace TwoQ
{
    public partial class frmQuestao08 : Form
    {
        // ==== VIDAS
        Image img_vidasFull;
        ...
        Image img_btn_correto08_normal; // botão normal
        Image img_btn_correto08_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto08_normal; // botão normal
        Image img_btn_quasecorreto08_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado08_normal; // botão normal
        Image img_btn_errado08_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo08_normal; // botão normal
        Image img_btn_absurdo08_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao08()
        {
            ...
            img_btn_correto08_normal = Properties.Resources.btn_correto08_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto08_normal
            img_btn_correto08_high = Properties.Resources.btn_correto08_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto08_high

            img_btn_quasecorreto08_normal = Properties.Resources.btn_quasecorreto08_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto08_normal
            img_btn_quasecorreto08_high = Properties.Resources.btn_quasecorreto08_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto08_high

            img_btn_errado08_normal = Properties.Resources.btn_errado08_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado08_normal
            img_btn_errado08_high = Properties.Resources.btn_errado08_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado08_high

            img_btn_absurdo08_normal = Properties.Resources.btn_absurdo08_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo08_normal
            img_btn_absurdo08_high = Properties.Resources.btn_absurdo08_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo08_high
        }


        int alternativas;
        private void frmQuestao08_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto08_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto08_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado08_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo08_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao08_RespotaCorreta RespostaCorreta = new frmQuestao08_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto08_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao08_RespostaErrada RespostaErrada = new frmQuestao08_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto08_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado08_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo08_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
