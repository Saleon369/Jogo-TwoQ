...
namespace TwoQ
{
    public partial class frmQuestao01_RespostaErrada : Form
    {

        // === Imagem Pergunta Errada 01
        Image img_resposta_errada_01;
        Image img_resposta_errada_certa_01;
        ...
        public frmQuestao01_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_01 = Properties.Resources.Resposta_Errada_01;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_01
            img_resposta_errada_certa_01 = Properties.Resources.Resposta_Errada_Certa_01; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_01
        ...
        private void frmQuestao01_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_01;  // atribuição da imagem na picturebox (resposta_errada_01)
        }
        ...
        {
            frmQuestao02 Questao02 = new frmQuestao02();
            this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_01; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_01; // Altera para a imagem com a dica
