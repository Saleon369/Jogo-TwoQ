...
namespace TwoQ
{    public partial class frmQuestao04_RespostaErrada : Form
    {

        // === Imagem Pergunta Errada 04
        Image img_resposta_errada_04;
        Image img_resposta_errada_certa_04;
        ...
        public frmQuestao04_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_04 = Properties.Resources.Resposta_Errada_04;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_04
            img_resposta_errada_certa_04 = Properties.Resources.Resposta_Errada_Certa_04; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_04
        ...
        private void frmQuestao04_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_04;  // atribuição da imagem na picturebox (resposta_errada_04)
        }
        ...
        {
            frmQuestao05 Questao05 = new frmQuestao05();
            this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_04; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_04; // Altera para a imagem com a dica
