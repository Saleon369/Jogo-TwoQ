...
namespace TwoQ
{
    public partial class frmQuestao12 : Form
    {
        ...
        Image img_btn_correto12_normal; // botão normal
        Image img_btn_correto12_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto12_normal; // botão normal
        Image img_btn_quasecorreto12_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado12_normal; // botão normal
        Image img_btn_errado12_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo12_normal; // botão normal
        Image img_btn_absurdo12_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao12()
        {
            ...
            img_btn_correto12_normal = Properties.Resources.btn_correto12_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto12_normal
            img_btn_correto12_high = Properties.Resources.btn_correto12_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto12_high

            img_btn_quasecorreto12_normal = Properties.Resources.btn_quasecorreto12_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto12_normal
            img_btn_quasecorreto12_high = Properties.Resources.btn_quasecorreto12_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto12_high

            img_btn_errado12_normal = Properties.Resources.btn_errado12_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado12_normal
            img_btn_errado12_high = Properties.Resources.btn_errado12_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado12_high

            img_btn_absurdo12_normal = Properties.Resources.btn_absurdo12_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo12_normal
            img_btn_absurdo12_high = Properties.Resources.btn_absurdo12_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo12_high
        }


        int alternativas;
        private void frmQuestao12_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto12_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto12_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado12_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo12_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao12_RespotaCorreta RespostaCorreta = new frmQuestao12_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto12_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao12_RespostaErrada RespostaErrada = new frmQuestao12_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto12_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado12_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo12_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
