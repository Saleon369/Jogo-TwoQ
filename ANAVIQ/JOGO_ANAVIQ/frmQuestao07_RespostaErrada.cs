...
namespace TwoQ
{    public partial class frmQuestao07_RespostaErrada : Form
    {   
        // === Imagem Pergunta Errada 07
        Image img_resposta_errada_07;
        Image img_resposta_errada_certa_07;
        ...
        public frmQuestao07_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_07 = Properties.Resources.Resposta_Errada_07;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_07
            img_resposta_errada_certa_07 = Properties.Resources.Resposta_Errada_Certa_07; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_07
        ...
        private void frmQuestao07_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_07;  // atribuição da imagem na picturebox (resposta_errada_07)
        }
        ...
        private void btn_proximo_Click(object sender, EventArgs e)
        {
            ...
            {
                frmQuestao08 Questao08 = new frmQuestao08();
                this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_07; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_07; // Altera para a imagem com a dica
