...
namespace TwoQ
{
    ...
    { 
        ...
        Image img_btn_correto02_normal; // botão normal
        Image img_btn_correto02_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto02_normal; // botão normal
        Image img_btn_quasecorreto02_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado02_normal; // botão normal
        Image img_btn_errado02_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo02_normal; // botão normal
        Image img_btn_absurdo02_high; // quando o mouse passa por cima do botão
        ...
        public frmQuestao02()
        {
            ...
            img_btn_correto02_normal = Properties.Resources.btn_correto02_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto02_normal
            img_btn_correto02_high = Properties.Resources.btn_correto02_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto02_high

            img_btn_quasecorreto02_normal = Properties.Resources.btn_quasecorreto02_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto02_normal
            img_btn_quasecorreto02_high = Properties.Resources.btn_quasecorreto02_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto02_high

            img_btn_errado02_normal = Properties.Resources.btn_errado02_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado02_normal
            img_btn_errado02_high = Properties.Resources.btn_errado02_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado02_high

            img_btn_absurdo02_normal = Properties.Resources.btn_absurdo02_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo02_normal
            img_btn_absurdo02_high = Properties.Resources.btn_absurdo02_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo02_high
        }


        int alternativas;
        private void frmQuestao02_Load(object sender, EventArgs e)
        {
            ...
            btn_correto.BackgroundImage = img_btn_correto02_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto02_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado02_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo02_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao02_RespotaCorreta RespostaCorreta = new frmQuestao02_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto02_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao02_RespostaErrada RespostaErrada = new frmQuestao02_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto02_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado02_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo02_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
