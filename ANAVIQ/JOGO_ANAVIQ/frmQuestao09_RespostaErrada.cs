...
namespace TwoQ
{    public partial class frmQuestao09_RespostaErrada : Form
    {
        // === Imagem Pergunta Errada 09
        Image img_resposta_errada_09;
        Image img_resposta_errada_certa_09;
        ...
        public frmQuestao09_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_09 = Properties.Resources.Resposta_Errada_09;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_09
            img_resposta_errada_certa_09 = Properties.Resources.Resposta_Errada_Certa_09; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_09
        ...
        private void frmQuestao09_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_09;  // atribuição da imagem na picturebox (resposta_errada_09)
        }
        ...
        private void btn_proximo_Click(object sender, EventArgs e)
        {
            ...
            {
                frmQuestao10 Questao10 = new frmQuestao10();
                this.Visible = false;
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_09; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_09; // Altera para a imagem com a dica
