...
namespace TwoQ
{    public partial class frmQuestao10_RespostaErrada : Form
    {
        // === Imagem Pergunta Errada 10
        Image img_resposta_errada_10;
        Image img_resposta_errada_certa_10;
        ...
        public frmQuestao10_RespostaErrada()
        {
            InitializeComponent();

            img_resposta_errada_10 = Properties.Resources.Resposta_Errada_10;   // atribui a imagem da pasta "images" na variavel btn_resposta_errada_10
            img_resposta_errada_certa_10 = Properties.Resources.Resposta_Errada_Certa_10; // atribui a imagem da pasta "images" na variavel btn_resposta_errada_cerca_10
        ...
        private void frmQuestao10_RespostaErrada_Load(object sender, EventArgs e)
        {
            ...
            resposta_errada.BackgroundImage = img_resposta_errada_10;  // atribuição da imagem na picturebox (resposta_errada_10)
        }
        ...
        private void btn_proximo_Click(object sender, EventArgs e)
        {
            ...
            {
                frmQuestao11 Questao11 = new frmQuestao11();
                this.Visible = false;
                Questao11.ShowDialog();
                this.Close();
            }
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_certa_10; // Altera para a imagem com a resposta certa
        ...
        {
            resposta_errada.BackgroundImage = img_resposta_errada_10; // Altera para a imagem com a dica
