...
namespace TwoQ
{
    public partial class frmQuestao01 : Form
    {
        ...
        Image img_btn_correto01_normal; // botão normal
        Image img_btn_correto01_high; // quando o mouse passa por cima do botão

        // ==== BOTAO QUASE CORRETO ( Alternativa ERRADA ) 
        Image img_btn_quasecorreto01_normal; // botão normal
        Image img_btn_quasecorreto01_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ERRADO  ( Alternativa ERRADA )
        Image img_btn_errado01_normal; // botão normal
        Image img_btn_errado01_high; // quando o mouse passa por cima do botão

        // ==== BOTAO ABSURDO  ( Alternativa ERRADA )
        Image img_btn_absurdo01_normal; // botão normal
        Image img_btn_absurdo01_high; // quando o mouse passa por cima do botão

        public frmQuestao01()
        {
            InitializeComponent();

            img_vidas = Properties.Resources.Vida_Full; // atribui a imagem da pasta "images" na variavel img_vidas 
            ...
            img_btn_correto01_normal = Properties.Resources.btn_correto01_normal; // Atribui a imagem da pasta "images" na variavel img_btn_correto01_normal
            img_btn_correto01_high = Properties.Resources.btn_correto01_high;   // atribui a imagem da pasta "images" na variavel img_btn_correto01_high

            img_btn_quasecorreto01_normal = Properties.Resources.btn_quasecorreto01_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_quasecorreto01_normal
            img_btn_quasecorreto01_high = Properties.Resources.btn_quasecorreto01_high;  // atribui a imagem da pasta "images" na variavel img_btn_quasecorreto01_high

            img_btn_errado01_normal = Properties.Resources.btn_errado01_normal;  // Atribui a imagem da pasta "images" na variavel img_btn_errado01_normal
            img_btn_errado01_high = Properties.Resources.btn_errado01_high;  // atribui a imagem da pasta "images" na variavel img_btn_errado01_high

            img_btn_absurdo01_normal = Properties.Resources.btn_absurdo01_normal;// Atribui a imagem da pasta "images" na variavel img_btn_absurdo01_normal
            img_btn_absurdo01_high = Properties.Resources.btn_absurdo01_high;  // atribui a imagem da pasta "images" na variavel img_btn_absurdo01_high
        }


        int alternativas;
        private void frmQuestao01_Load(object sender, EventArgs e)
        {
            lblnome.Text = VariaveisGlobais.nome;

            vidas.BackgroundImage = img_vidas;   // atribuição da imagem na picturebox ( vidas ) 
            btn_voltar.BackgroundImage = img_btn_voltar_normal;  // atribuição da imagem na picturebox ( btn_voltar )
            btn_correto.BackgroundImage = img_btn_correto01_normal;  // atribuição da imagem na picturebox ( btn_correto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto01_normal;  // atribuição da imagem na picturebox ( btn_quasecorreto )
            btn_errado.BackgroundImage = img_btn_errado01_normal; // atribuição da imagem na picturebox ( btn_errado )
            btn_absurdo.BackgroundImage = img_btn_absurdo01_normal; // atribuição da imagem na picturebox ( btn_absurdo )
        ...
        private void btn_correto_Click(object sender, EventArgs e)
        {
            ...
            if(Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao01_RespotaCorreta RespostaCorreta = new frmQuestao01_RespotaCorreta();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_correto.BackgroundImage = img_btn_correto01_high; // atribuição da imagem na picturebox ( btn_correto )
        }
        ...
        private void btn_quasecorreto_Click(object sender, EventArgs e)
        {
            ...
            if (Resposta == DialogResult.Yes)
            {
                ...
                frmQuestao01_RespostaErrada RespostaErrada = new frmQuestao01_RespostaErrada();
                this.Visible = false;
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_quasecorreto.BackgroundImage = img_btn_quasecorreto01_high; // atribuição da imagem na picturebox ( btn_quasecorreto )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_errado.BackgroundImage = img_btn_errado01_high; // atribuição da imagem na picturebox ( btn_errado )
        }
        ...
        {
            // altera a imagem para high ( altera a imagem para high quando mouse entra na foto )
            btn_absurdo.BackgroundImage = img_btn_absurdo01_high; // atribuição da imagem na picturebox ( btn_absurdo )
        }
